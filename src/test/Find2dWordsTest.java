...
class Find2dWordsTest
{
	...
	@Test
	void findGivenWordsInMapBaseExample()
	{
		char[][] charMap =
		{
			{'o','a','a','n'},
		...
		List<String> output = Find2dWords.findGivenWordsInMap(charMap, dictionary);

		assert output.size() == 2;
		assert output.contains("oath");
		assert output.contains("eat");
	}
	
	@Test
	void firstFailedLeetCodeExample()
	{
		char[][] charMap =
		{
			{'a','b','c'},
		...
		dictionary.add("gfedcbaaa");
		dictionary.add("eaabcdgfa");
		dictionary.add("befa");
		dictionary.add("dgc");
		dictionary.add("ade");
	...
	void secondFailedLCExample()
	{
		...
		List<String> output = methodWrapper(charMap, words);
		System.out.println(output.toString());
		assert output.contains("aabbbbabbaababaaaabababbaaba");
		assert output.contains("abaabbbaaaaababbbaaaaabbbaab");
		assert output.contains("ababaababaaabbabbaabbaabbaba");
	}

	@Test
	void thirdFailedLCExample()
	{
		char[][] charMap =
		{
			{'a','b'},
	...
	@Test
	void timeLimitExceededLCExample()
	{
		char[][] charMap =
		{
			{'a','a','a','a'},
	...
	private List<String> methodWrapper(char[][] charMap, String[] words)
	{
		List<String> dictionary = new ArrayList<>();
		...
		return Find2dWords.findGivenWordsInMap(charMap, dictionary);
	}
}